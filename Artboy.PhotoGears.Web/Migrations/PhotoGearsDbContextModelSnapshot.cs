...
namespace Artboy.PhotoGears.Web.Migrations
{
    ...
    partial class PhotoGearsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Artboy.PhotoGears.Web.Models.Accessory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Artboy.PhotoGears.Web.Models.Camera", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Artboy.PhotoGears.Web.Models.GearImage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Artboy.PhotoGears.Web.Models.Lens", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Artboy.PhotoGears.Web.Models.Mount", b =>
                {
                    b.Property<int>("MountId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Artboy.PhotoGears.Web.Models.Camera", b =>
                {
                    b.HasOne("Artboy.PhotoGears.Web.Models.Lens", "AssociatedLens")
                        .WithMany()
                        .HasForeignKey("LensId");

                    b.HasOne("Artboy.PhotoGears.Web.Models.Mount", "LensMount")
                        .WithMany()
            ...
            modelBuilder.Entity("Artboy.PhotoGears.Web.Models.GearImage", b =>
                {
                    b.HasOne("Artboy.PhotoGears.Web.Models.Accessory", null)
                        .WithMany("Images")
                        .HasForeignKey("AccessoryId");

                    b.HasOne("Artboy.PhotoGears.Web.Models.Camera", null)
                        .WithMany("Images")
                        .HasForeignKey("CameraId");

                    b.HasOne("Artboy.PhotoGears.Web.Models.Lens", null)
                        .WithMany("Images")
                        .HasForeignKey("LensId");
                });
